const project_list = [
    {
        id: 1,
        name: 'MusyCharts',
        description: 'Aplicación web interactiva que transforma tus datos de Spotify en visualizaciones dinámicas y atractivas. Descubre tus patrones de escucha, artistas favoritos y géneros más reproducidos a través de gráficos interactivos.',
    ...
    },
    {
        ...
        description: 'Plataforma integral de gestión empresarial diseñada específicamente para pequeñas y medianas tiendas. Sistema completo de inventario, facturación, gestión de empleados, planillas y control de pedidos a domicilio.',
    ...
    },
    {
        id: 3,
        name: 'RatioInsights',
        description: 'Herramienta de análisis financiero empresarial que calcula automáticamente ratios financieros clave y los compara con benchmarks de la industria. Importación directa desde Excel para agilizar el análisis.',
        longDescription: 'Plataforma de análisis financiero que permite a empresas y analistas evaluar la salud financiera mediante el cálculo automático de ratios de liquidez, rentabilidad, endeudamiento y eficiencia. Incluye comparación con estándares de la industria y generación de reportes ejecutivos.',
        date: '2023',
    ...
    },
    {
        id: 4,
        name: 'CheRooms SV',
        description: 'Plataforma social para conectar personas que buscan roommates en San Salvador. Sistema de perfiles, matching por preferencias y chat en tiempo real para facilitar la búsqueda de compañeros de vivienda.',
        longDescription: 'Red social especializada que facilita la búsqueda de compañeros de cuarto en San Salvador. Incluye sistema de perfiles verificados, algoritmo de matching basado en preferencias (presupuesto, ubicación, estilo de vida), chat en tiempo real y sistema de reseñas de usuarios.',
        date: '2022',
        client: 'Proyecto Universitario',
